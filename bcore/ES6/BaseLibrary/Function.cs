...
namespace Bcoring.ES6.BaseLibrary
{
    ...
    public partial class Function : JSObject, ICallable
    {
        ...
        public virtual JSValue Construct(Arguments arguments)
        {
            ...
            {
                ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.InvalidTryToCreateWithNew, name));
            }
        ...
        public JSValue Call(JSValue targetObject, Arguments arguments)
        {
            ...
            {
                ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.InvalidTryToCreateWithoutNew, name));
            }

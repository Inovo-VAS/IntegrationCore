...
namespace Bcoring.ES6
{
    ...
    {
        /// <exception cref="Bcoring.ES6.Core.JSException">
        /// </exception>
        ...
        internal static void ThrowVariableIsNotDefined(string variableName, Context context, CodeNode exceptionMaker)
        {
            ...
            Throw(new ReferenceError(string.Format(Bcoring.ES6.JS.VariableNotDefined, variableName)), exceptionMaker, code);
        }
        ...
        {
            Throw(new ReferenceError(string.Format(Bcoring.ES6.JS.VariableNotDefined, variableName)), exceptionMaker, null);
        }
        ...
        {
            Throw(new TypeError(string.Format(Bcoring.ES6.JS.IncrementPropertyWOSetter, proprtyName)));
        }
        ...
        {
            Throw(new TypeError(string.Format(Bcoring.ES6.JS.IncrementReadonly, entityName)));
        }
        ...
        internal static void ThrowUnknownToken(string code, int index)
        {
            ...
            Throw(new SyntaxError(string.Format(
                Bcoring.ES6.JS.UnknowIdentifier,
        ...
        internal static T ThrowIfNotExists<T>(T obj, object name) where T : JSValue
        {
            if (obj._valueType == JSValueType.NotExists)
                ExceptionHelper.Throw((new Bcoring.ES6.BaseLibrary.ReferenceError("Variable \"" + name + "\" is not defined.")));
            return obj;
        }

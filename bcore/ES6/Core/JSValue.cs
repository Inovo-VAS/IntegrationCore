...
using Bcoring.ES6.Backward;
using Bcoring.ES6.BaseLibrary;
using Bcoring.ES6.Core.Functions;
...
#pragma warning restore CA1707 // Идентификаторы не должны содержать символы подчеркивания
        ...
        internal protected virtual JSValue GetProperty(JSValue key, bool forWrite, PropertyScope propertyScope)
        {
            switch (_valueType)
            {
                ...
                {
                    ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.TryingToGetProperty, key, "undefined"));
                    return null;
                }
                default:
                {
                    if (_oValue == this)
                        break;
                    if (_oValue == null)
                        ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.TryingToGetProperty, key, "null"));
        ...
        internal protected virtual void SetProperty(JSValue name, JSValue value, PropertyScope propertyScope, bool throwOnError)
        {
            ...
            {
                if (_oValue == null)
                    ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.TryingToSetProperty, name, "null"));
            ...
            {
                ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.TryingToSetProperty, name, "undefined"));
            }
        }
        ...
        internal protected virtual bool DeleteProperty(JSValue name)
        {
            ...
            {
                if (_oValue == null)
                    ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.TryingToGetProperty, name, "null"));
                if (_oValue == this)
                    throw new InvalidOperationException();
                ...
                ExceptionHelper.ThrowTypeError(string.Format(Bcoring.ES6.JS.TryingToGetProperty, name, "undefined"));
            return true;
        }
        ...
        {
            return new Bcoring.ES6.BaseLibrary.String(value.ToString());
        }
        #endregion
        ...
        {
            return (Bcoring.ES6.BaseLibrary.Boolean)value;
        }
        ...
        {
            return new Bcoring.ES6.BaseLibrary.String(value);
        }

    ...
    public class SIPUserAgent : IDisposable
    {
        ...
        private async Task DialogRequestReceivedAsync(SIPRequest sipRequest)
        {
            ...
            else if (sipRequest.Method == SIPMethodsEnum.INVITE)
            {
                ...
                {
                    logger.LogError(new Exception("MediaSession can't process the re-INVITE request.", ex));
            ...
            if (m_sipDialogue != null)
            {
                    ...
                    sipRequest.Header.CallId == m_sipDialogue.CallId)
                {
                    ...
                    catch (Exception excp)
                    {
                        ...
                        logger.LogError(new Exception( $"Exception SIPUserAgent.SIPTransportRequestReceived. {excp.Message}", excp));
                    }
                }

...
namespace Lnksnk.Core.Utilities
{
    public static class ReflectionUtils
    {
        ...
        public static object StringToTypedValue(string sourceString, Type targetType, CultureInfo culture = null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    throw (new InvalidCastException("Type Conversion not handled in StringToTypedValue faild:"+ targetType.Name));
                }
            }
        ...
        public static List<KeyValuePair<string, string>> GetEnumList(Type enumType, bool valueAsFieldValueNumber = false)
        {
            ...
            foreach (var enumValue in enumValues)
            {
                ...
                if (!valueAsFieldValueNumber)
                    items.Add(new KeyValuePair<string, string>(enumValue.ToString(), FromCamelCase(strValue)));
                else
                    items.Add(new KeyValuePair<string, string>(((int)enumValue).ToString(),
                        FromCamelCase(strValue)
                    ));
            }
            return items;
        }
        ...
        public static string FromCamelCase(string camelCase)
        {
            ...
            System.Text.StringBuilder sb = new System.Text.StringBuilder(camelCase.Length + 10);
            bool first = true;
            char lastChar = '\0';

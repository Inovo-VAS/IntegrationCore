...
namespace Bcoring.ES6
{
    class JS
    {
        ...
        public const string DoNotDeclareFunctionInNestedBlocks = @"Constructor cannot be static";
        ...
        public const string InvalidTryToCreateWithNew = @"Type ""{0}"" can not be created with new keyword";
        public const string InvalidTryToCreateWithoutNew = @"Type ""{0}"" can not be created without new keyword";
        public const string LogicalNullishCoalescing = @"It is not possible to combine both the AND (&&) and OR operators (||) directly with ??";
        public const string TooManyArgumentsForFunction = @"Too many arguments for function ""{0}""";
        public const string TryingToGetProperty = @"Can't get property ""{0}"" of ""{1}""";
        public const string TryingToSetProperty = @"Can't set property ""{0}"" of ""{1}""";
        public const string UnexpectedEndOfSource = @"Unexpected end of source";
